...
const Navbar = () => {
  ...
  return (
    ...
    <div className='w-[100%] h-[10vh] bg-[#4166af] flex items-center rounded-[15px] shadow-2xl shadow-slate-200 justify-around p-3 text-white text-[20px] font-bold'>
      <div className='w-[50%] flex items-center text-left cursor-pointer ' onClick={()=>navigate('/Homepage')}>Rentify</div>
      ...
      {/* <div className='w-[20px] h-[20px] text-[15px] absolute rounded-[50%] flex items-center justify-center left-[63.9%] top-3 bg-red-800'>{count}</div> */}
